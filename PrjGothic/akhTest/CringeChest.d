...
instance Chest_199005010_CringeChest(Npc_Default)
{
	name[0] = "Кринж сундук";
...
func void CringeChest_GivePCaLotOfNugget()
{
    ...
    CreateInvItems(hero,ItMiNugget,9999);
};
...
func void DLG_CringeChest_Unlock_Info()
{
    ...
    if(Npc_HasItems(other,ItKeLockpick))
    {
        ...
        Info_AddChoice(DLG_CringeChest_Unlock,"Повернуть вправо",CringeChest_Random);
    }
    else
    {
