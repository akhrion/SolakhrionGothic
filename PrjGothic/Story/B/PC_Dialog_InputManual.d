...
/////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
const string NAME_PC_InputManual_Digit = "-” ј«ј“№ „»—Ћќ-";
...
func void InputManual_Digit_Info_Loop()
{
    if(InputManual_Digit_DialogTheme == InputManual_Digit_ALEPH_SECRETS_NUGGET)
    {
        ...
        Info_AddChoice(VLK_585_Aleph_SCHUPPEN,"—тереть",InputManual_Digit_Clear);
        Info_AddChoice(VLK_585_Aleph_SCHUPPEN,"ѕодтвердить",VLK_585_Aleph_SCHUPPEN_N);
