...
func void b_give_fortunochapter1herbs()
{
	...
	CreateInvItems(npc,ItMiJoint_1,30);
	CreateInvItems(npc,ItMiJoint_2,20);
	CreateInvItems(npc,ItMiJoint_3,10);
	CreateInvItems(npc,ItMiNugget,237);
	CreateInvItems(npc,ItFo_Plants_Berrys_01,7);
...
func void b_give_fortunochapter2herbs()
{
	...
	CreateInvItems(npc,ItMiJoint_2,10);
	CreateInvItems(npc,ItMiJoint_3,10);
