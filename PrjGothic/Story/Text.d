...
const string MOBNAME_ORE = "Чистая руды";
const string MOBNAME_ORE_GROUND = "Залежи руды";
const string MOBNAME_GOLD_GROUND = "Залежи золота";
const string MOBNAME_GROUND = "Грунт";
...
const string MOBNAME_ORE_GROUND_MILL = "";
...
const string NAME_Overseer = "Надзиратель";
...
const string NAME_SCAVENGERAGRESSIVE = "Агрессивный падальщик";
const string DIALOG_ENDE = "ЗАКОНЧИТЬ РАЗГОВОР";
const string DIALOG_BACK = "НАЗАД";
const string DIALOG_CONFIRM_INPUT = "ЗАДАТЬ ВОПРОС";
const string DIALOG_ENDE_INPUT = "ЗАКОНЧИТЬ РАССПРОСЫ";
const string DIALOG_WORD_NUMBER = "НОМЕР СЛОВА";
const string DIALOG_WORD_NUMBER_01 = "1ое СЛОВО";
const string DIALOG_WORD_NUMBER_02 = "2ое СЛОВО";
const string DIALOG_WORD_NUMBER_03 = "3ое СЛОВО";
const string DIALOG_WORD_NUMBER_04 = "4ое СЛОВО";
const string DIALOG_WORD_NUMBER_05 = "5ое СЛОВО";
const string DIALOG_WORD_NUMBER_06 = "6ое СЛОВО";
const string DIALOG_WORD_NUMBER_07 = "7ое СЛОВО";
const string DIALOG_WORD_ERASE = "СТЕРЕТЬ СЛОВО";
const string DIALOG_NEW_PHRASE = "НОВАЯ ФРАЗА";
...
const string NAME_PC_Dialog_InputManual = "Спросить..";
...
const string NAME_PROT_INDEX_EDGE = "Защита от оружия:";
const string NAME_PROT_INDEX_POINT = "Защита от стрел:";
const string NAME_PROT_INDEX_FIRE = "Защита от огня:";
const string NAME_PROT_INDEX_MAGIC = "Защита от магии:";
...
const string _STR_MESSAGE_PICKLOCK_SUCCESSLOUD = "Слышу очень громкий щелчок.";
const string _STR_MESSAGE_PICKLOCK_UNLOCK = "Замок взломан.";
const string _STR_MESSAGE_PICKLOCK_FAILURE = "Черт... Ничего на вышло.";
const string _STR_MESSAGE_PICKLOCK_FAILURECHANCE = "Отмычка не поворачивается.";
const string _STR_MESSAGE_PICKLOCK_BROKEN = "Отмычка сломалась.";
const string _STR_MESSAGE_PICKLOCK_BROKENLOCK = "Замок окончательно сломан, отмычки тут больше не помогут.";
...
const string STR_INFO_MENU_EXIT = "ЗАКРЫТЬ";
const string NAME_EQUIP_NEEDABOW = "Для этого мне нужен какой-нибудь лук";
const string NAME_EQUIP_NEEDACROSSBOW = "Для этого мне нужен какой-нибудь арбалет";
const string NAME_EQUIP_NEEDARANGEDWEAPON = "Нужно дальнобойное оружие";
const string NAME_EQUIPPED_ARROW = "Стрелы экипированы";
