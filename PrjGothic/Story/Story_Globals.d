...
const int FireGolem_Aura_Damage_Near = 100;
const int FireGolem_Aura_Damage_Normal = 10;
const int FireGolem_Aura_Damage_Far = 1;
...
const int SPWN_MAX_ATATIME_Swampherb_01 = 20;
...
const int ATTRIBUTESCAP_DEX_LOW = 1;
const int ATTRIBUTESCAP_DEX_EYELESS = 10;
const int ATTRIBUTESCAP_DEX_NORMAL = 30;
const int ATTRIBUTESCAP_DEX_ACCURATE = 70;
const int ATTRIBUTESCAP_DEX_ROBINHOOD = 150;
...
//вопервых переменные будут сбрасыватьс€ к изначальным после перезахода в игру
//во вторых и третьих при перезагрузке или новой игре, переменные будут сохран€ть свои значени€
// т.е. return SPWN[3] -> FALSE -> SPWN[3] = TRUE -> LOADING -> return SPWN[3] -> TRUE
// const int и var int ведут себ€ идентично - разница лишь в инициализации: константы на предкомпиле, а вары в рантайме.
...
var int PC_WasTrade;
var int PC_LastTradeTimestamp;//дл€ понимани€ насколько сильно могли изменитьс€ цены с последнего посещени€ торговца
...
////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////ѕодсчитывают общее количество монстров в игре
////////////////////////////////////////////////////////////////////////////////////////////////
...
var int PC_Knowledge_Demon_Existence;//„ем больше узнаЄт игрок о жизни демонов, тем проще ему удерживать их в нашем мире. «начение не меньше 2 - дл€ корректной отработки в AI_StartState [20240607184143]
var int PC_Knowledge_Demon_Info;
const int PC_KNOWLEDGE_DEMON_INFODELAY_CONST = 3;
var int PC_Knowledge_Demon_InfoDelay;
var int PC_StoppedAiming;//»грок выстрелил или прекратил прицеливатьс€, либо его прервали.
...
var int Value_Apple;
const int HP_Apfel = 2;
var int Value_Wineberry;
const int HP_Weintrauben = 2;
var int Value_Water;
...
const int HP_Reisschnaps = 2;
var int Value_Rice;
const int HP_Reis = 7;
var int Value_Wurzelsuppe;
const int HP_Wurzelsuppe = 4;
var int Value_Meatbugragout;
const int HP_Ragout = 12;
...
const int DAM_TRAMPLED_AMOUNT = 30;
