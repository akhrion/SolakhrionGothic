...
func void VLK_585_Aleph_INFO_FewNugget_Info()
{
	...
	AI_Output(self,other,"VLK_585_Aleph_INFO_FewNugget_NULL_02"); //Вообще не носишь!? Парень ты еще не знаешь кого здесь можно повстречать. Если ты наткнешься не на тех людей.
	AI_Output(self,other,"VLK_585_Aleph_INFO_FewNugget_NULL_03"); //Или они сами тебя найдут, а руды у тебя при себе не будет, тоо.. они могут захотеть не грабить тебя, а как-то иначе скоротать досуг, понимаешь?
	AI_Output(self,other,"VLK_585_Aleph_INFO_FewNugget_NULL_04"); //И я знаю одного хорошего парня.. вернее я знал одного хорошего парня. Еще пару дней назад мы с ним дурили стражников.. Он думал, что сможет обдурить каждого здесь, в этой колонии.. Он думал.. Да какая разница теперь, что он думал.
	AI_Output(self,other,"VLK_585_Aleph_INFO_FewNugget_NULL_05"); //А что думаешь ты?
};
