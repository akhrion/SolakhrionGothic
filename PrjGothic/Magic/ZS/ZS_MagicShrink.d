...
func int ZS_MagicShrink_Loop()
{
	...
	else if(self.aivar[AIV_MM_ShrinkState] == 13)
	{
		...
		self.protection[PROT_INDEX_BLUNT] = self.protection[PROT_INDEX_BLUNT] / 10;
		self.protection[PROT_INDEX_EDGE] = self.protection[PROT_INDEX_EDGE] / 10;
		self.protection[PROT_INDEX_FIRE] = self.protection[PROT_INDEX_FIRE] / 10;
		self.protection[PROT_INDEX_FLY] = 0;
		self.protection[PROT_INDEX_MAGIC] = self.protection[PROT_INDEX_MAGIC] / 10;
		self.protection[PROT_INDEX_POINT] = self.protection[PROT_INDEX_POINT] / 10;
