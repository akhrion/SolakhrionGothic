...
const int BS_DIVE = 7;
const int BS_JUMP = 8;
const int BS_CLIMB = 32777;                 //взаимодействие с лестницей
const int BS_FALL = 10;
const int BS_SIT = 65547;
const int BS_LIE = 12;
const int BS_INVENTORY = 13;                //нахождение в инвентаре сундука, сбрасывание предмета на землю из инвентаря (необходим цикл 0.5 секунды для гарантированного отлавливания этого флага)
const int BS_ITEMINTERACT = 32782;          //чтение книг, свитков, поедание предметов (сохраняется пару секунд после начала)
const int BS_MOBINTERACT = 15;              //нажатие кнопки действия на рычаги и их инициация
const int BS_MOBINTERACT_INTERRUPT = 32784; //нажатие книпки действия на сундук
const int BS_TAKEITEM = 17;                 //подбирание предметов с земли
